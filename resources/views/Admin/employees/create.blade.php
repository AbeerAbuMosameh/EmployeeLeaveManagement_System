                        ...
                        <div class="form-group row pt-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <x-input name='phone' type='text' value='{{ $employee->phone }}' placeholder="Enter Phone"></x-input>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}"
                                        ...
                                        <option
                                            value="marketing" {{ old('department') === 'marketing' ? 'selected' : '' }}>
                                            Marketing
                                        </option>
                                        ...
                                        <option
                                            value="operations" {{ old('department') === 'operations' ? 'selected' : '' }}>
                                            Operations
                                        </option>
                                        <option
                                            value="research" {{ old('department') === 'research' ? 'selected' : '' }}>
                                            Research
                                        </option>
                                    </select>
                                </div>
